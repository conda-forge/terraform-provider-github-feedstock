...
validate_recipe_outputs "terraform-provider-github-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="terraform-provider-github-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi